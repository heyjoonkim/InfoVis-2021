...
def agnew_preprocess(example, tokenizer, prompt):
    # data for PLM
    example_with_prompt = f'{example["text"]} {prompt}'
    encoded_input = tokenizer(example_with_prompt, truncation=True, max_length=256, padding='max_length')
